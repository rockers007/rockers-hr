---
name: rockers-hr
description: Use this skill when building or modifying any feature in the Rockers HR project (NestJS backend, Next.js frontend, Flutter mobile, PostgreSQL). Contains architectural patterns, code conventions, validation rules, Playwright testing recipes, S3 upload flow, probation logic, and master data patterns specific to this codebase.
---
...
*Rockers HR — SKILL.md | Implementation reference for all agents and sessions*
